function updateBITS(latestbit, i) % L : why need this 
% USAGE: 
...
if i==N  %no bits need to be updated
    return;
elseif i<=(PCparams.N/2) % the former half bits, N = 8, then bits 1~4
...
%     end
    ...
    PCparams.BITS(2,1) = latestbit; % the later half bits
    % tree update
